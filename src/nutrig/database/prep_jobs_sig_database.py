...
output_dir = f'/sps/grand/pcorrea/nutrig/database/v1/sig/{sim_soft}_{primary.lower()}_{rf_chain}_th1_{thresh1}_th2_{thresh2}'
noise_dir  = f'/sps/grand/pcorrea/nutrig/database/v1/bkg/gp13_pretrigger_stationary_th1_{thresh1}_th2_{thresh2}'
...
if __name__ == '__main__':
    ...
    for i in range(n_jobs):
        ...
        for j in range(n_files_per_job):
            try:
                script_text_new = '\n\npython3 /pbs/home/p/pcorrea/grand/nutrig/database/v1/make_sig_database.py {} -o {} -n {} -s {}'
